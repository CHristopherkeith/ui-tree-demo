        ...
        return {
          ...
          link: function (scope, element, attrs, controllersArr) {
            ...
            selectElement=function(e){
              ...
              isHandleChild = UiTreeHelper.elementIsTreeNodeHandle(eventElm);
              //console.log(isHandleChild)
              if (isHandleChild) {
                eventElm = angular.element(eventElm[0].parentNode);
                //console.log(eventElm);
                //console.log(eventElm==UiTreeHelper.selectElement);
                oldVal= UiTreeHelper.selectElement;
                UiTreeHelper.selectElement = eventElm;
                UiTreeHelper.selectElementScope = eventElm.controller('uiTreeNode').scope;
               //console.log(oldVal);
               //console.log(UiTreeHelper.selectElement)
               //console.log(oldVal === UiTreeHelper.selectElement)
            ...
            selectElementEvent=function(e){
              selectElement(e);
              stopPropagation(e);
            }
             //console.log(scope)
            angular.element(element).bind('click',selectElementEvent)
